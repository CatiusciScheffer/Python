...
def extrair_informacoes(pdf_file):
    ...
    with fitz.open(pdf_file) as pdf_document:
        ...
        gfip = 'Pendência - Omissão de GFIP'
        debitos_SIEF = 'Pendência - Débito (SIEF)'
        parcelamento_SISPAR = 'Pendência - Parcelamento (SISPAR)'
        inscricao_divida= 'Pendência - Inscrição (Sistema DIVIDA)'
        exigibilidade_suspensa = 'Inscrição com Exigibilidade Suspensa (SIDA)'
